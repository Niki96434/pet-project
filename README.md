...
src/app/ # Инициализация, провайдеры, роутинг
src/pages/ # Компоненты страниц
src/widgets/ # Крупные UI-блоки (календарь, заголовок)
src/features/ # Фичи добавления и изменения задач через форму.
src/entities/ # Бизнес-сущности (Task)
src/shared/ # Переиспользуемые утилиты, UI-кит, API-клиент, библиотеки
---
