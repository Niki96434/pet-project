...
├── widgets/ # Крупные UI-блоки (календарь, заголовок)
├── features/ # Фичи добавления и изменения задач через форму.
├── entities/ # Бизнес-сущности (Task)
└── shared/ # Переиспользуемые утилиты, UI-кит, API-клиент, библиотеки
---
