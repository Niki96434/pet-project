...
export function AddTaskForm({ handleModal }: AddTaskFormProps) {
  const { mutationCreateTask, createTask } = useCreateTaskMutation({
    handleModal,
  });
    ...
    <div className="add-form-wrapper">
      ...
      >
        ...
        <FormInput
          ...
          children={""}
        />
        <span title="error-hint" className="error-hint">
        ...
        <div className="form-button-container">
          <button type="button" className="close-button" onClick={handleModal}>
            Cancel
          </button>
          <button
            type="submit"
            className="submit-button"
            disabled={mutationCreateTask.isPending || !isValid}
          >
            Add task
          </button>
        </div>
